...
public class FinalVars {
	...
	public static final String GEMINI_TLS_FILE = "my-gemini.jks";	// modify if named otherwise
	public static final String GEMINI_TLS_PASS = "GEMINI_PASS";
	...
	public static final int MAX_REPLY_HEADER_SIZE = 1027; // Status Code (2) + Space (1) + Meta (1024)
}
